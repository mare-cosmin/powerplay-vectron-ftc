...
//        drive.cone_down_low_fata();
        ...
        TrajectorySequence baseSeq = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToSplineHeading(new Pose2d(x_mid-2, -y+2, Math.toRadians(135)))
        ...
        if (!isStopRequested()) {
            ...
            if (tag == 4) {
                TrajectorySequence park2Seq = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                        .lineToLinearHeading(new Pose2d(x_mid-3, -y + 3, Math.toRadians(0)))
                        .UNSTABLE_addTemporalMarkerOffset(0.5, drive::pickup_fata)
                        .build();
                ...
                if (tag == 3) {
                    ...
                    TrajectorySequence park3Seq = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                            ...
                            .lineToLinearHeading(new Pose2d(x_pickup+5, -y + 3, Math.toRadians(0)))
