...
//            pickup_fata();
    ...
    public void lift_pos_up(int pos) {
        ...
        if (lift_exp.getCurrentPosition() <= pos + 10 && (robot_height.equals(TeleOpAdaptedMecanumDrive.Height.LOW) || robot_height.equals(TeleOpAdaptedMecanumDrive.Height.MEDIUM))) {
...
//        servo_brat_sus.setPosition(1);
    ...
    public void cone_up_mid_fata(){
        if(robot_height.equals(TeleOpAdaptedMecanumDrive.Height.LOW)) {
            lift_pos_up(350);
            robot_height = TeleOpAdaptedMecanumDrive.Height.MEDIUM;
        }
        servo_rotation.setPosition(servo_rot_down);
